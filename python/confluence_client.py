...
class ConfluenceClient:
    ...
    async def search_pages(
        ...
        params = {"cql": cql_query, "limit": limit, "expand": "space,version"}

        result = await self._request("GET", "/content/search", params=params)

        # Format results for easier consumption
        formatted_results = {"query": query, "total_results": result.get("size", 0), "pages": []}
    ...
    async def get_page(self, page_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "ancestors": [
                {"id": a.get("id"), "title": a.get("title")} for a in result.get("ancestors", [])
            ],
        }
    ...
    async def get_page_content(
        ...
        Returns:
            Full page content
        """
        result = await self._request("GET", f"/content/{page_id}", params={"expand": expand})
        ...
        return {
            ...
            "body": {"format": body_storage.get("representation", ""), "content": body_content},
    ...
    async def list_spaces(self, limit: int = 50) -> Dict[str, Any]:
        ...
        formatted_spaces = {"total": result.get("size", 0), "spaces": []}
    ...
    async def search_by_title(
        ...
        # Format results
        formatted_results = {"title_query": title, "total_results": result.get("size", 0), "pages": []}
